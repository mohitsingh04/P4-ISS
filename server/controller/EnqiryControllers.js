import { addEnquiryCount } from "../AnalyticController/EnquiryCountController.js";
...
// import Enquiry from "../models/Enquiry.js";  // Adjust the path as necessary
// import { addEnquiryCount } from "../controllers/enquiryController.js";  // Import the function
...
export const addEnquiry = async (req, res) => {
  try {
    ...
    await addEnquiryCount(property_id); // Pass property_id to the count function

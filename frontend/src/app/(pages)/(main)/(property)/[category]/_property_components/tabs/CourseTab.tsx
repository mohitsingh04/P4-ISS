  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Our Courses</h2>
        <p className="text-gray-600">
          Comprehensive yoga education programs for all levels
        </p>
      </div>
            ...
            >
              <div className="relative w-full h-48">
                <Image
                  src={
                    course?.image[0]
                      ? `${process.env.NEXT_PUBLIC_URL}/course/${course?.image?.[0]}`

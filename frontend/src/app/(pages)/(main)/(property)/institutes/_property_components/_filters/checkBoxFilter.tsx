    ...
    <div className="space-y-2">
      <div className="relative">
        ...
        <input
          ...
          autoComplete="off"
          spellCheck="false"
          className="w-full pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none bg-white relative z-0 transition-all duration-200"
        />
      </div>
            ...
            return (
              ...
              >
                <div className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-700 group-hover:text-indigo-600 transition-colors cursor-pointer">
                    {item.name}
                  </span>
                </div>
